...
namespace Evelyn.Extension.UnitTest
{
    ...
    public class SimulatedConfiguratorValidation : SimulatedConfiguratorData
    {
        ...
        public void ReceiveTicks()
        {
            ...
            Assert.AreEqual(ErrorCodes.NoSuchInstrument, FeedHandler.Subscriptions[1].Item2.Code);
            ...
            Assert.AreEqual(ErrorCodes.NoSuchSubscription, FeedHandler.Subscriptions[3].Item2.Code);
        ...
        public void DeleteOrders()
        {
            ...
            Assert.AreEqual(ErrorCodes.SimBrokerNoSuchOrder, description.Code);
        }
    }
