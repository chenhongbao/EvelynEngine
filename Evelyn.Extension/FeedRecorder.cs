...
namespace Evelyn.Extension
{
    public class FeedRecorder : IAlgorithm
    {
        public void OnFeed(Tick tick)
        {
            ...
            {
                sw.WriteLine("{0}", Utilities.Format(tick));
            }
        }
        ...
        public void OnFeed(OHLC ohlc)
        {
            ...
            {
                sw.WriteLine("{0}", Utilities.Format(ohlc));
            }
        }
        ...
        public void OnFeed(Instrument instrument)
        {
            ...
            {
                sw.WriteLine("{0}", Utilities.Format(instrument));
            }
        }
        ...
        public static class Utilities
        {
            ...
            private static InstrumentStatus ParseInstrumentStatus(string value)
            {
            ...
            private static string Format(InstrumentStatus status)
            {
